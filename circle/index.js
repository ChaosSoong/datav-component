...
module.exports = Event.extend(
  function Base(container, config) {
    ...
    let random = Math.random()
      .toString(36)
      .substr(2)
    this.canvas.setAttribute('id', random)
    this.container.append(this.canvas)
    var c = document.getElementById(random)
  ...
  },
  {
    ...
    render: function(data, config) {
      ...
      this.ctx.arc(
        ...
        this.config.y,
        this.config.radius,
        Number(this.config.startingAngle) * Math.PI,
        Number(this.config.endingAngle) * Math.PI,
        true
      )
      ...
      // this.ctx.arc(0, 10, 100, 0, 0.5 * Math.PI)
      // this.ctx.stroke()
    },
    /**
     *
